...
public class ActivityTrungluoc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trungluoc);
        dbHelper = new DBHelper(ActivityTrungluoc.this);
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        recipeId = sharedPreferences.getInt("selected_recipe_id", 3);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isDeleted) {
                    Toast.makeText(ActivityTrungluoc.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(ActivityTrungluoc.this, "Xóa thất bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
