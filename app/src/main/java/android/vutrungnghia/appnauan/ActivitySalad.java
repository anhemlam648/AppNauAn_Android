...
public class ActivitySalad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(ActivitySalad.this);
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        recipeId = sharedPreferences.getInt("selected_recipe_id", 2);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isDeleted) {
                    Toast.makeText(ActivitySalad.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(ActivitySalad.this, "Xóa thất bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
