...
public class ActivityBanhKem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banhkem);

        // Initialize dbHelper
        dbHelper = new DBHelper(ActivityBanhKem.this);

        // Get the recipe ID from the shared preferences
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        recipeId = sharedPreferences.getInt("selected_recipe_id", 4);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isDeleted) {
                    Toast.makeText(ActivityBanhKem.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(ActivityBanhKem.this, "Xóa thất bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
